...
class DatabaseCounts(Gtk.Dialog):
    def __init__(self, *args):
        ...
        self.labelPlayerCount.set_text("%i" % (data.players.get_player_count()))
        ...
        self.labelClubCount.set_text("%i" % (data.clubs.get_club_count()))
        ...
        self.labelLeagueCount.set_text("%i" % (data.leagues.get_league_count()))
        ...
        self.labelNationCount.set_text("%i" % (data.nations.get_nation_count()))
